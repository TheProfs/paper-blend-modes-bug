 ...
 *
 * @NOTE Modifications by @nicholaswmin:
 *
 * - `Item` and `Project` now call `this.ctor()` so that any `ctor` constructor
 *    methods on injector functions get called.
 */
...
var Project = PaperScopeItem.extend({
    ...
    if (this.ctor) this.ctor(...arguments)
	},
